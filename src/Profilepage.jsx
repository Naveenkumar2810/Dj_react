...
const Profilepage = () => {
  ...
  return (
    <div className='Profile w-full h-full flex justify-center items-center rounded-xl'>
      {!edit.edit_mode?
        <div className='Profile md:w-2/5 w-5/6 md:h-3/5 h-4/6 shadow-card-hl rounded-3xl flex flex-col gap-5 p-3'>
           <div className='Image md:w-52 w-32 md:h-52 h-32 rounded-full mx-auto border-[6px] border-[#cbd5e1] overflow-hidden flex justify-center items-center'>
             <h1 className='font-semibold w-5/6 h-5/6 md:text-8xl text-5xl place-content-center'>{prof.username.charAt(0)}</h1>
           </div>
           <div className='info-name flex flex-row shadow-card-hl rounded-xl bg-card'>
             <span className='w-1/2 md:h-14 h-10 text-xs md:text-lg px-3 font-bold flex items-center'>Name</span>
             <span className='w-1/2 md:h-14 h-10 text-xs md:text-sm px-3 flex items-center justify-end'>{prof.username}</span>
           ...
           <div className='info-pass flex flex-row shadow-card-hl rounded-xl bg-card'>
             <span className='w-1/2 md:h-14 h-10  text-xs md:text-lg px-3 font-bold flex items-center'>Email</span>
             <span className='w-1/2 md:h-14 h-10  text-xs md:text-sm px-3 flex items-center justify-end'>test@gmail.com</span>
           ...
           <div className='info-addr flex flex-row shadow-card-hl rounded-xl bg-card'>
             <span className='w-1/2 md:h-14 h-10  text-xs md:text-lg px-3 font-bold flex items-center'>Phone</span>
             <span className='w-1/2 md:h-14 h-10  text-xs md:text-sm px-3 flex items-center justify-end'>{prof.mobile_number}</span>
           ...
           <button onClick={()=>{deleteCookie()}} className='md:w-4/5 w-2/5 md:p-2 p-1 text-xs md:test-base bg-red-500 rounded-full mx-auto'>Log out</button>
        </div>:
