  ...
  return (
    <div className='border border-black w-full h-full rounded-xl bg-cus-white p-3 md:p-3 scroll-smooth overflow-y-auto scrollbar-thin scrollbar-track-gray-100 scrollbar-thumb-gray-400 '>
        <nav className='w-full md:w-[calc(98%)] mx-auto md:h-auto h-12 flex flex-row md:gap-8 py-2 mb-3 md:mt-0 relative bg-card shadow-card-hl rounded-full'>
          ...
          <div className={`z-50 md:w-2/6 w-1/6 md:h-full ${menubar?'h-64':'h-10'} flex md:flex-row flex-col md:justify-evenly md:items-center gap-3 md:gap-0 rounded-3xl bg-card overflow-hidden md:overflow-visible px-1 items-center`} >
              ...
              <span onClick={()=>{setmenuBar(!menubar)}} className='cartpage md:w-auto flex items-center rounded-full bg-card md:shadow-card-hl md:p-3 py-2 px-2'>
              ...
              <span onClick={()=>{setmenuBar(!menubar)}} className='reorder md:w-auto flex items-center md:p-3 p-2 rounded-full bg-card md:shadow-card-hl'>
                <Link to="">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
              ...
              <span onClick={()=>{setmenuBar(!menubar)}} className='profilepage md:w-auto flex items-center md:p-3 p-2 rounded-full bg-card md:shadow-card-hl'>
